...
class KmeansDemo(object):
    ...
    def point_cluster(self, cluster_num=4):
        ...
        while True:
            ...
            if temp_centroid[0]['x'] == next_centroid[0]['x'] \
                and temp_centroid[0]['y'] == next_centroid[0]['y'] \
                and temp_centroid[1]['x'] == next_centroid[1]['x'] \
                and temp_centroid[1]['y'] == next_centroid[1]['y'] \
                and temp_centroid[2]['x'] == next_centroid[2]['x'] \
                and temp_centroid[2]['y'] == next_centroid[2]['y'] \
                and temp_centroid[3]['x'] == next_centroid[3]['x'] \
                and temp_centroid[3]['y'] == next_centroid[3]['y']:
                break
            else:
                temp_centroid = next_centroid
                continue
